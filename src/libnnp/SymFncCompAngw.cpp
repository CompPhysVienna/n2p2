...
void SymFncCompAngw::setParameters(string const& parameterString)
{
...
void SymFncCompAngw::changeLengthUnit(double convLength)
{
...
string SymFncCompAngw::getSettingsLine() const
{
...
bool SymFncCompAngw::getCompactAngle(double x, double& fx, double& dfx) const
{
    bool const stat = ca.fdf(x, fx, dfx);
    return stat;
}

bool SymFncCompAngw::getCompactRadial(double x, double& fx, double& dfx) const
{
...
string SymFncCompAngw::parameterLine() const
{
...
vector<string> SymFncCompAngw::parameterInfo() const
{
...
double SymFncCompAngw::calculateRadialPart(double distance) const
{
...
double SymFncCompAngw::calculateAngularPart(double angle) const
{
    return ca.f(angle);
}

bool SymFncCompAngw::checkRelevantElement(size_t index) const
{

...
#ifndef SYMGRPCUTOFFBASED_H
#define SYMGRPCUTOFFBASED_H
...
class SymGrpCutoffBased : public SymGrp
{
public:
...
protected:
     ...
     */
    SymGrpCutoffBased(std::size_t type, ElementMap const& elementMap);
};

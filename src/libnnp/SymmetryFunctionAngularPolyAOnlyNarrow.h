...
#ifndef SYMMETRYFUNCTIONANGULARPOLYAONLYNARROW_H
#define SYMMETRYFUNCTIONANGULARPOLYAONLYNARROW_H
 ...
 */
class SymmetryFunctionAngularPolyAOnlyNarrow : public SymmetryFunction
{
public:
...
inline bool SymmetryFunctionAngularPolyAOnlyNarrow::
...
inline std::size_t SymmetryFunctionAngularPolyAOnlyNarrow::getE1() const
{
    return e1;
}

inline std::size_t SymmetryFunctionAngularPolyAOnlyNarrow::getE2() const
{
    return e2;
}

inline double SymmetryFunctionAngularPolyAOnlyNarrow::getAngleLeft() const
{
    return angleLeft;
}

inline double SymmetryFunctionAngularPolyAOnlyNarrow::getAngleRight() const
{
    return angleRight;
}

inline double SymmetryFunctionAngularPolyAOnlyNarrow::getRl() const
{
    return rl;
}

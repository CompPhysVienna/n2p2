 ...
 * - @f$\alpha@f$
 */
class SymGrpRadPolyA : public SymGrp
{
public:
    /** Constructor, sets type = 2
     */
    SymGrpRadPolyA(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
private:
    ...
    std::vector<SymFncRadPolyA const*> members;
...
inline bool SymGrpRadPolyA::operator!=(SymGrp const& rhs) const
{
    return !((*this) == rhs);
}

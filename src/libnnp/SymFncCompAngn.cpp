...
void SymFncCompAngn::setParameters(string const& parameterString)
{
...
void SymFncCompAngn::changeLengthUnit(double convLength)
{
...
string SymFncCompAngn::getSettingsLine() const
{
...
bool SymFncCompAngn::getCompactAngle(double x, double& fx, double& dfx) const
{
    bool const stat = ca.fdf(x, fx, dfx);
    return stat;
}

bool SymFncCompAngn::getCompactRadial(double x, double& fx, double& dfx) const
{
...
string SymFncCompAngn::parameterLine() const
{
...
vector<string> SymFncCompAngn::parameterInfo() const
{
...
double SymFncCompAngn::calculateRadialPart(double distance) const
{
...
double SymFncCompAngn::calculateAngularPart(double angle) const
{
    return ca.f(angle);
}

bool SymFncCompAngn::checkRelevantElement(size_t index) const
{

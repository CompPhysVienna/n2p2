 ...
 */
class SymFncAngwComp : public SymFncBaseComp
{
public:
...
inline std::size_t SymFncAngwComp::getE1() const { return e1; }
inline std::size_t SymFncAngwComp::getE2() const { return e2; }
inline double SymFncAngwComp::getAngleLeft() const { return angleLeft; }
inline double SymFncAngwComp::getAngleRight() const { return angleRight; }

...
public:
     ...
     */
    SymGrpAngnExpWeighted(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
private:
    ...
    std::vector<SymFncAngnExpWeighted const*> members;
...
inline bool SymGrpAngnExpWeighted::operator!=(SymGrp const& rhs) const
{
    return !((*this) == rhs);
}

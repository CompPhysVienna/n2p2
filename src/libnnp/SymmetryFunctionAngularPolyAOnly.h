...
#ifndef SYMMETRYFUNCTIONANGULARPOLYAONLY_H
#define SYMMETRYFUNCTIONANGULARPOLYAONLY_H
 ...
 */
class SymmetryFunctionAngularPolyAOnly : public SymmetryFunction
{
public:
...
inline bool SymmetryFunctionAngularPolyAOnly::
...
inline std::size_t SymmetryFunctionAngularPolyAOnly::getE1() const
{
    return e1;
}

inline std::size_t SymmetryFunctionAngularPolyAOnly::getE2() const
{
    return e2;
}

inline double SymmetryFunctionAngularPolyAOnly::getAngleLeft() const
{
    return angleLeft;
}

inline double SymmetryFunctionAngularPolyAOnly::getAngleRight() const
{
    return angleRight;
}

inline double SymmetryFunctionAngularPolyAOnly::getRl() const
{
    return rl;
}

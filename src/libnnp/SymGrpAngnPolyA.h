...
//TODO  * - @f$\alpha@f$
//TODO  */
class SymGrpAngnPolyA : public SymGrp
{
public:
    /** Constructor, sets type = 99
     */
    SymGrpAngnPolyA(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
private:
    ...
    std::vector<SymFncAngnPolyA const*> members;
...
inline bool SymGrpAngnPolyA::operator!=(SymGrp const& rhs) const
{
    return !((*this) == rhs);
}

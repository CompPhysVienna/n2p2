...
#ifndef SYMMETRYFUNCTIONRADIALPOLYA_H
#define SYMMETRYFUNCTIONRADIALPOLYA_H
 ...
 *
 * @f[
 * G^2_i = \text{PolyAnomial goes here}
 * @f]
 * Parameter string:
 * ```
 ...
 * - `<rc>..................` @f$r_{c}@f$
 */
class SymmetryFunctionRadialPolyA : public SymmetryFunction
{
public:
    /** Constructor, sets type = 2
     */
    SymmetryFunctionRadialPolyA(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
inline std::size_t SymmetryFunctionRadialPolyA::getE1() const
{
    return e1;
}

inline double SymmetryFunctionRadialPolyA::getRl() const
{
    return rl;
}

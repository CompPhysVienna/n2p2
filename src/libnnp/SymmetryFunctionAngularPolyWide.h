...
#ifndef SYMMETRYFUNCTIONANGULARPOLYWIDE_H
#define SYMMETRYFUNCTIONANGULARPOLYWIDE_H
 ...
 * Parameter string:
 * ```
 * <element-central> 29 <element-neighbor1> <element-neighbor2> <eta> <left> <right> <rcutoff> <<rshift>>
 * ```
 * where
 ...
 */
class SymmetryFunctionAngularPolyWide : public SymmetryFunction
{
public:
...
inline bool SymmetryFunctionAngularPolyWide::
...
inline std::size_t SymmetryFunctionAngularPolyWide::getE1() const
{
    return e1;
}

inline std::size_t SymmetryFunctionAngularPolyWide::getE2() const
{
    return e2;
}

inline double SymmetryFunctionAngularPolyWide::getAngleLeft() const
{
    return angleLeft;
}

inline double SymmetryFunctionAngularPolyWide::getAngleRight() const
{
    return angleRight;
}

inline double SymmetryFunctionAngularPolyWide::getEta() const
{
    return eta;
}

inline double SymmetryFunctionAngularPolyWide::getRs() const
{
    return rs;
}

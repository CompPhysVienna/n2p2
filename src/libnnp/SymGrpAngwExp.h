...
#ifndef SYMGRPANGWEXP_H
#define SYMGRPANGWEXP_H
 ...
 * - @f$\alpha@f$
 */
class SymGrpAngwExp : public SymGrpCutoffBased
{
public:
    /** Constructor, sets type = 3
     */
    SymGrpAngwExp(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
private:
    ...
    std::vector<SymFncAngwExp const*> members;
...
inline bool SymGrpAngwExp::operator!=(SymGrp const& rhs) const
{
    return !((*this) == rhs);
}

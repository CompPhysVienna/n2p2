...
#ifndef SYMMETRYFUNCTIONGROUPANGULARPOLYAONLYNARROW_H
#define SYMMETRYFUNCTIONGROUPANGULARPOLYAONLYNARROW_H
...
class SymmetryFunctionAngularPolyAOnlyNarrow;
...
//TODO  * - @f$\alpha@f$
//TODO  */
class SymmetryFunctionGroupAngularPolyAOnlyNarrow : public SymmetryFunctionGroup
{
public:
...
private:
    ...
    std::vector<SymmetryFunctionAngularPolyAOnlyNarrow const*> members;
...
inline bool SymmetryFunctionGroupAngularPolyAOnlyNarrow::

...
SymmetryFunctionGroupRadialPolyA::
SymmetryFunctionGroupRadialPolyA(ElementMap const& elementMap) :
    SymmetryFunctionGroup(280, elementMap),
    e1(0),
    rl(0)
{
...
bool SymmetryFunctionGroupRadialPolyA::
operator==(SymmetryFunctionGroup const& rhs) const
{
    if (ec   != rhs.getEc()  ) return false;
    if (type != rhs.getType()) return false;
    SymmetryFunctionGroupRadialPolyA const& c =
        dynamic_cast<SymmetryFunctionGroupRadialPolyA const&>(rhs);
...
addMember(SymmetryFunction const* const symmetryFunction)
{
    ...
    SymmetryFunctionRadialPolyA const* sf =
        dynamic_cast<SymmetryFunctionRadialPolyA const*>(symmetryFunction);
...
void SymmetryFunctionGroupRadialPolyA::sortMembers()
{
    sort(members.begin(),
         members.end(),
         comparePointerTargets<SymmetryFunctionRadialPolyA const>);
...
void SymmetryFunctionGroupRadialPolyA::setScalingFactors()
{
...
void SymmetryFunctionGroupRadialPolyA::calculate(Atom&      atom,
...
vector<string> SymmetryFunctionGroupRadialPolyA::parameterLines() const
{
    vector<string> v;

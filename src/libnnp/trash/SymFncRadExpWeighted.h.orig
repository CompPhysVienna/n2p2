...
public:
     ...
     */
    SymFncRadExpWeighted(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
inline bool SymFncRadExpWeighted::operator!=(SymFnc const& rhs) const
{
    return !((*this) == rhs);
}
...
inline double SymFncRadExpWeighted::getEta() const
{
    return eta;
}

inline double SymFncRadExpWeighted::getRs() const
{
    return rs;
}

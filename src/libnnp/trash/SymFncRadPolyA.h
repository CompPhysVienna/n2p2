 ...
 * - `<rc>..................` @f$r_{c}@f$
 */
class SymFncRadPolyA : public SymFnc
{
public:
    /** Constructor, sets type = 2
     */
    SymFncRadPolyA(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
inline bool SymFncRadPolyA::operator!=(SymFnc const& rhs) const
{
    return !((*this) == rhs);
}
...
inline std::size_t SymFncRadPolyA::getE1() const
{
    return e1;
}

inline double SymFncRadPolyA::getRl() const
{
    return rl;
}

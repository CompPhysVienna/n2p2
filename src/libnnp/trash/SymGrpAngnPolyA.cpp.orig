...
SymmetryFunctionGroupAngularPolyAOnlyNarrow::
SymmetryFunctionGroupAngularPolyAOnlyNarrow(ElementMap const& elementMap) :
    SymmetryFunctionGroup(990, elementMap),
    e1(0),
    e2(0)
{
...
bool SymmetryFunctionGroupAngularPolyAOnlyNarrow::
operator==(SymmetryFunctionGroup const& rhs) const
{
    if (ec   != rhs.getEc()  ) return false;
    if (type != rhs.getType()) return false;
    SymmetryFunctionGroupAngularPolyAOnlyNarrow const& c =
        dynamic_cast<SymmetryFunctionGroupAngularPolyAOnlyNarrow const&>(rhs);
...
addMember(SymmetryFunction const* const symmetryFunction)
{
    ...
    SymmetryFunctionAngularPolyAOnlyNarrow const* sf =
        dynamic_cast<SymmetryFunctionAngularPolyAOnlyNarrow const*>(
        symmetryFunction);
...
void SymmetryFunctionGroupAngularPolyAOnlyNarrow::sortMembers()
{
    sort(members.begin(),
         members.end(),
         comparePointerTargets<SymmetryFunctionAngularPolyAOnlyNarrow const>);
...
void SymmetryFunctionGroupAngularPolyAOnlyNarrow::setScalingFactors()
{
...
void SymmetryFunctionGroupAngularPolyAOnlyNarrow::calculate(Atom&      atom,
...
vector<string> SymmetryFunctionGroupAngularPolyAOnlyNarrow::parameterLines() const
{
    vector<string> v;
    int const    izero = 0.0;

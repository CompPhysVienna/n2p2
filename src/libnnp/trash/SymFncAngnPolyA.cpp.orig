...
SymmetryFunctionAngularPolyAOnlyNarrow::
SymmetryFunctionAngularPolyAOnlyNarrow(ElementMap const& elementMap) :
    SymmetryFunction(990, elementMap),
    e1           (0    ),
    e2           (0    ),
    rl           (0.0  ),
    angleLeft    (0.0  ),
...
bool SymmetryFunctionAngularPolyAOnlyNarrow::
operator==(SymmetryFunction const& rhs) const
{
    if (ec   != rhs.getEc()  ) return false;
    if (type != rhs.getType()) return false;
    SymmetryFunctionAngularPolyAOnlyNarrow const& c =
        dynamic_cast<SymmetryFunctionAngularPolyAOnlyNarrow const&>(rhs);
...
void SymmetryFunctionAngularPolyAOnlyNarrow::
setParameters(string const& parameterString)
{
    ...
    cr.setType(CompactFunction::Type::POLYA);
...
void SymmetryFunctionAngularPolyAOnlyNarrow::changeLengthUnit(double convLength)
{
...
string SymmetryFunctionAngularPolyAOnlyNarrow::getSettingsLine() const
{
...
bool SymmetryFunctionAngularPolyAOnlyNarrow::getCompactAngle(double x, double& fx, double& dfx) const
{
    bool const stat = ca.fdf(x, fx, dfx);
    return stat;
}

bool SymmetryFunctionAngularPolyAOnlyNarrow::getCompactRadial(double x, double& fx, double& dfx) const
{
    bool const stat = cr.fdf(x, fx, dfx);
    return stat;
}

void SymmetryFunctionAngularPolyAOnlyNarrow::calculate(Atom&      atom,
...
string SymmetryFunctionAngularPolyAOnlyNarrow::parameterLine() const
{
    int const    izero = 0;
...
vector<string> SymmetryFunctionAngularPolyAOnlyNarrow::parameterInfo() const
{
...
double SymmetryFunctionAngularPolyAOnlyNarrow::calculateRadialPart(double distance) const
{
...
double SymmetryFunctionAngularPolyAOnlyNarrow::calculateAngularPart(double angle) const
{
    return ca.f(angle);
}

bool SymmetryFunctionAngularPolyAOnlyNarrow::checkRelevantElement(size_t index) const
{

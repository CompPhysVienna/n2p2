 ...
 * - @f$\alpha@f$
 */
class SymGrpRadExpWeighted : public SymGrpBaseCutoff
{
public:
    /** Constructor, sets type = 12
     */
    SymGrpRadExpWeighted(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
private:
    ...
    std::vector<SymFncRadExpWeighted const*> members;
...
inline bool SymGrpRadExpWeighted::operator!=(SymGrp const& rhs) const
{
    return !((*this) == rhs);
}

...
SymmetryFunctionAngularPolyAOnly::
SymmetryFunctionAngularPolyAOnly(ElementMap const& elementMap) :
    SymmetryFunction(890, elementMap),
    e1           (0    ),
    e2           (0    ),
    rl           (0.0  ),
    angleLeft    (0.0  ),
...
bool SymmetryFunctionAngularPolyAOnly::
operator==(SymmetryFunction const& rhs) const
{
    if (ec   != rhs.getEc()  ) return false;
    if (type != rhs.getType()) return false;
    SymmetryFunctionAngularPolyAOnly const& c =
        dynamic_cast<SymmetryFunctionAngularPolyAOnly const&>(rhs);
...
void SymmetryFunctionAngularPolyAOnly::
...
void SymmetryFunctionAngularPolyAOnly::changeLengthUnit(double convLength)
{
...
string SymmetryFunctionAngularPolyAOnly::getSettingsLine() const
{
...
bool SymmetryFunctionAngularPolyAOnly::getCompactAngle(double x, double& fx, double& dfx) const
{
    bool const stat = ca.fdf(x, fx, dfx);
    return stat;
}

bool SymmetryFunctionAngularPolyAOnly::getCompactRadial(double x, double& fx, double& dfx) const
{
    bool const stat = cr.fdf(x, fx, dfx);
    return stat;
}

void SymmetryFunctionAngularPolyAOnly::calculate(Atom&      atom,
...
string SymmetryFunctionAngularPolyAOnly::parameterLine() const
{
    int const    izero = 0;
...
vector<string> SymmetryFunctionAngularPolyAOnly::parameterInfo() const
{
...
double SymmetryFunctionAngularPolyAOnly::calculateRadialPart(double distance) const
{
...
double SymmetryFunctionAngularPolyAOnly::calculateAngularPart(double angle) const
{
    return ca.f(angle);
}

bool SymmetryFunctionAngularPolyAOnly::checkRelevantElement(size_t index) const
{

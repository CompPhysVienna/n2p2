...
//TODO  * - @f$\alpha@f$
//TODO  */
class SymGrpAngwPolyA : public SymGrp
{
public:
    /** Constructor, sets type = 89
     */
    SymGrpAngwPolyA(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
private:
    ...
    std::vector<SymFncAngwPolyA const*> members;
...
inline bool SymGrpAngwPolyA::operator!=(SymGrp const& rhs) const
{
    return !((*this) == rhs);
}

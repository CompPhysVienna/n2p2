...
#ifndef SYMMETRYFUNCTIONGROUPRADIALPOLY_H
#define SYMMETRYFUNCTIONGROUPRADIALPOLY_H
...
class SymmetryFunctionRadialPoly;
 ...
 * - @f$\alpha@f$
 */
class SymmetryFunctionGroupRadialPoly : public SymmetryFunctionGroup
{
public:
...
private:
    ...
    std::vector<SymmetryFunctionRadialPoly const*> members;
...
inline bool SymmetryFunctionGroupRadialPoly::

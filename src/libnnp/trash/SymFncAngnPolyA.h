 ...
 */
class SymFncAngnPolyA : public SymFnc
{
public:
    /** Constructor, sets type = 99
    */
    SymFncAngnPolyA(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
inline bool SymFncAngnPolyA::operator!=(SymFnc const& rhs) const
{
    return !((*this) == rhs);
}
...
inline std::size_t SymFncAngnPolyA::getE1() const
{
    return e1;
}

inline std::size_t SymFncAngnPolyA::getE2() const
{
    return e2;
}

inline double SymFncAngnPolyA::getAngleLeft() const
{
    return angleLeft;
}

inline double SymFncAngnPolyA::getAngleRight() const
{
    return angleRight;
}

inline double SymFncAngnPolyA::getRl() const
{
    return rl;
}

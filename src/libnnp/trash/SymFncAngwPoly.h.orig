...
#ifndef SYMMETRYFUNCTIONANGULARPOLYONLY_H
#define SYMMETRYFUNCTIONANGULARPOLYONLY_H
 ...
 */
class SymmetryFunctionAngularPolyOnly : public SymmetryFunction
{
public:
...
inline bool SymmetryFunctionAngularPolyOnly::
...
inline std::size_t SymmetryFunctionAngularPolyOnly::getE1() const
{
    return e1;
}

inline std::size_t SymmetryFunctionAngularPolyOnly::getE2() const
{
    return e2;
}

inline double SymmetryFunctionAngularPolyOnly::getAngleLeft() const
{
    return angleLeft;
}

inline double SymmetryFunctionAngularPolyOnly::getAngleRight() const
{
    return angleRight;
}

inline double SymmetryFunctionAngularPolyOnly::getRl() const
{
    return rl;
}

...
#ifndef SYMMETRYFUNCTIONRADIALPOLY_H
#define SYMMETRYFUNCTIONRADIALPOLY_H
 ...
 * - `<rc>..................` @f$r_{c}@f$
 */
class SymmetryFunctionRadialPoly : public SymmetryFunction
{
public:
    /** Constructor, sets type = 2
     */
    SymmetryFunctionRadialPoly(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
inline std::size_t SymmetryFunctionRadialPoly::getE1() const
{
    return e1;
}

inline double SymmetryFunctionRadialPoly::getRl() const
{
    return rl;
}

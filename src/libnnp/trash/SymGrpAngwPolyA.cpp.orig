...
SymmetryFunctionGroupAngularPolyAOnly::
SymmetryFunctionGroupAngularPolyAOnly(ElementMap const& elementMap) :
    SymmetryFunctionGroup(890, elementMap),
    e1(0),
    e2(0)
{
...
bool SymmetryFunctionGroupAngularPolyAOnly::
operator==(SymmetryFunctionGroup const& rhs) const
{
    if (ec   != rhs.getEc()  ) return false;
    if (type != rhs.getType()) return false;
    SymmetryFunctionGroupAngularPolyAOnly const& c =
        dynamic_cast<SymmetryFunctionGroupAngularPolyAOnly const&>(rhs);
...
addMember(SymmetryFunction const* const symmetryFunction)
{
    ...
    SymmetryFunctionAngularPolyAOnly const* sf =
        dynamic_cast<SymmetryFunctionAngularPolyAOnly const*>(
        symmetryFunction);
...
void SymmetryFunctionGroupAngularPolyAOnly::sortMembers()
{
    sort(members.begin(),
         members.end(),
         comparePointerTargets<SymmetryFunctionAngularPolyAOnly const>);
...
void SymmetryFunctionGroupAngularPolyAOnly::setScalingFactors()
{
...
void SymmetryFunctionGroupAngularPolyAOnly::calculate(Atom&      atom,
...
vector<string> SymmetryFunctionGroupAngularPolyAOnly::parameterLines() const
{
    vector<string> v;
    int const    izero = 0.0;

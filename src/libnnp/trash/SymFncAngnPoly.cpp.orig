...
SymmetryFunctionAngularPolyOnlyNarrow::
SymmetryFunctionAngularPolyOnlyNarrow(ElementMap const& elementMap) :
    SymmetryFunction(99, elementMap),
    e1           (0    ),
    e2           (0    ),
    rl           (0.0  ),
    angleLeft    (0.0  ),
...
bool SymmetryFunctionAngularPolyOnlyNarrow::
operator==(SymmetryFunction const& rhs) const
{
    if (ec   != rhs.getEc()  ) return false;
    if (type != rhs.getType()) return false;
    SymmetryFunctionAngularPolyOnlyNarrow const& c =
        dynamic_cast<SymmetryFunctionAngularPolyOnlyNarrow const&>(rhs);
...
void SymmetryFunctionAngularPolyOnlyNarrow::
...
void SymmetryFunctionAngularPolyOnlyNarrow::changeLengthUnit(double convLength)
{
...
string SymmetryFunctionAngularPolyOnlyNarrow::getSettingsLine() const
{
...
bool SymmetryFunctionAngularPolyOnlyNarrow::getCompactAngle(double x, double& fx, double& dfx) const
{
    bool const stat = ca.fdf(x, fx, dfx);
    return stat;
}

bool SymmetryFunctionAngularPolyOnlyNarrow::getCompactRadial(double x, double& fx, double& dfx) const
{
    bool const stat = cr.fdf(x, fx, dfx);
    return stat;
}

void SymmetryFunctionAngularPolyOnlyNarrow::calculate(Atom&      atom,
...
string SymmetryFunctionAngularPolyOnlyNarrow::parameterLine() const
{
    int const    izero = 0;
...
vector<string> SymmetryFunctionAngularPolyOnlyNarrow::parameterInfo() const
{
...
double SymmetryFunctionAngularPolyOnlyNarrow::calculateRadialPart(double distance) const
{
...
double SymmetryFunctionAngularPolyOnlyNarrow::calculateAngularPart(double angle) const
{
    return ca.f(angle);
}

bool SymmetryFunctionAngularPolyOnlyNarrow::checkRelevantElement(size_t index) const
{

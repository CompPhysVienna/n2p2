...
#ifndef SYMFNCANGNEXP_H
#define SYMFNCANGNEXP_H
 ...
 */
class SymFncAngnExp : public SymFncBaseCutoff
{
public:
    /** Constructor, sets type = 3
     */
    SymFncAngnExp(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
inline bool SymFncAngnExp::getUseIntegerPow() const { return useIntegerPow; }
inline std::size_t SymFncAngnExp::getE1() const { return e1; }
inline std::size_t SymFncAngnExp::getE2() const { return e2; }
inline int SymFncAngnExp::getZetaInt() const { return zetaInt; }
inline double SymFncAngnExp::getLambda() const { return lambda; }
inline double SymFncAngnExp::getEta() const { return eta; }
inline double SymFncAngnExp::getZeta() const { return zeta; }
inline double SymFncAngnExp::getRs() const { return rs; }

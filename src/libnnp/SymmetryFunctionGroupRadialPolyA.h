...
#ifndef SYMMETRYFUNCTIONGROUPRADIALPOLYA_H
#define SYMMETRYFUNCTIONGROUPRADIALPOLYA_H
...
class SymmetryFunctionRadialPolyA;
 ...
 * - @f$\alpha@f$
 */
class SymmetryFunctionGroupRadialPolyA : public SymmetryFunctionGroup
{
public:
...
private:
    ...
    std::vector<SymmetryFunctionRadialPolyA const*> members;
...
inline bool SymmetryFunctionGroupRadialPolyA::

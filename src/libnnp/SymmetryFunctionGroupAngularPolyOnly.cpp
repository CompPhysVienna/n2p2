...
SymmetryFunctionGroupAngularPolyOnly::
SymmetryFunctionGroupAngularPolyOnly(ElementMap const& elementMap) :
    SymmetryFunctionGroup(89, elementMap),
    e1(0),
    e2(0)
{
...
operator==(SymmetryFunctionGroup const& rhs) const
{
    ...
    SymmetryFunctionGroupAngularPolyOnly const& c =
        dynamic_cast<SymmetryFunctionGroupAngularPolyOnly const&>(rhs);
...
addMember(SymmetryFunction const* const symmetryFunction)
{
    ...
    SymmetryFunctionAngularPolyOnly const* sf =
        dynamic_cast<SymmetryFunctionAngularPolyOnly const*>(
        symmetryFunction);
...
void SymmetryFunctionGroupAngularPolyOnly::sortMembers()
{
    sort(members.begin(),
         members.end(),
         comparePointerTargets<SymmetryFunctionAngularPolyOnly const>);
...
void SymmetryFunctionGroupAngularPolyOnly::setScalingFactors()
{
...
void SymmetryFunctionGroupAngularPolyOnly::calculate(Atom&      atom,

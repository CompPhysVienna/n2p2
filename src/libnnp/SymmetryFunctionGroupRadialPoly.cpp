...
SymmetryFunctionGroupRadialPoly::
SymmetryFunctionGroupRadialPoly(ElementMap const& elementMap) :
    SymmetryFunctionGroup(28, elementMap),
    e1(0),
    rl(0)
{
...
bool SymmetryFunctionGroupRadialPoly::
operator==(SymmetryFunctionGroup const& rhs) const
{
    if (ec   != rhs.getEc()  ) return false;
    if (type != rhs.getType()) return false;
    SymmetryFunctionGroupRadialPoly const& c =
        dynamic_cast<SymmetryFunctionGroupRadialPoly const&>(rhs);
...
addMember(SymmetryFunction const* const symmetryFunction)
{
    ...
    SymmetryFunctionRadialPoly const* sf =
        dynamic_cast<SymmetryFunctionRadialPoly const*>(symmetryFunction);
...
void SymmetryFunctionGroupRadialPoly::sortMembers()
{
    sort(members.begin(),
         members.end(),
         comparePointerTargets<SymmetryFunctionRadialPoly const>);
...
void SymmetryFunctionGroupRadialPoly::setScalingFactors()
{
...
void SymmetryFunctionGroupRadialPoly::calculate(Atom&      atom,
...
vector<string> SymmetryFunctionGroupRadialPoly::parameterLines() const
{
    vector<string> v;

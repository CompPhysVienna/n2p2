 ...
 */
class SymFncAngwPolyA : public SymFnc
{
public:
    /** Constructor, sets type = 89
     */
    SymFncAngwPolyA(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
inline bool SymFncAngwPolyA::operator!=(SymFnc const& rhs) const
{
    return !((*this) == rhs);
}
...
inline std::size_t SymFncAngwPolyA::getE1() const
{
    return e1;
}

inline std::size_t SymFncAngwPolyA::getE2() const
{
    return e2;
}

inline double SymFncAngwPolyA::getAngleLeft() const
{
    return angleLeft;
}

inline double SymFncAngwPolyA::getAngleRight() const
{
    return angleRight;
}

inline double SymFncAngwPolyA::getRl() const
{
    return rl;
}

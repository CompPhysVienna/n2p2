...
void SymFncExpAngw::setParameters(string const& parameterString)
{
...
void SymFncExpAngw::changeLengthUnit(double convLength)
{
...
string SymFncExpAngw::getSettingsLine() const
{
...
string SymFncExpAngw::parameterLine() const
{
...
vector<string> SymFncExpAngw::parameterInfo() const
{
...
double SymFncExpAngw::calculateRadialPart(double distance) const
{
...
double SymFncExpAngw::calculateAngularPart(double angle) const
{
    return 2.0 * pow((1.0 + lambda * cos(angle)) / 2.0, zeta);
}

bool SymFncExpAngw::checkRelevantElement(size_t index) const
{

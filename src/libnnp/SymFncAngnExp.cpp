...
SymFncAngnExp::SymFncAngnExp(ElementMap const& elementMap) :
    SymFncCutoffBased(3, elementMap),
    useIntegerPow(false),
    e1           (0    ),
    e2           (0    ),
    zetaInt      (0    ),
...
bool SymFncAngnExp::operator==(SymFnc const& rhs) const
{
    ...
    SymFncAngnExp const& c = dynamic_cast<SymFncAngnExp const&>(rhs);
...
void SymFncAngnExp::setParameters(string const& parameterString)
{
...
void SymFncAngnExp::changeLengthUnit(double convLength)
{
...
string SymFncAngnExp::getSettingsLine() const
{
...
void SymFncAngnExp::calculate(Atom& atom, bool const derivatives) const
{
...
string SymFncAngnExp::parameterLine() const
{
...
vector<string> SymFncAngnExp::parameterInfo() const
{
...
double SymFncAngnExp::calculateRadialPart(double distance) const
{
...
double SymFncAngnExp::calculateAngularPart(double angle) const
{
    return 2.0 * pow((1.0 + lambda * cos(angle)) / 2.0, zeta);
}

bool SymFncAngnExp::checkRelevantElement(size_t index) const
{

 ...
 */
class SymFncExpAngw : public SymFncBaseCutoff
{
public:
...
inline bool SymFncExpAngw::getUseIntegerPow() const { return useIntegerPow; }
inline std::size_t SymFncExpAngw::getE1() const { return e1; }
inline std::size_t SymFncExpAngw::getE2() const { return e2; }
inline int SymFncExpAngw::getZetaInt() const { return zetaInt; }
inline double SymFncExpAngw::getLambda() const { return lambda; }
inline double SymFncExpAngw::getEta() const { return eta; }
inline double SymFncExpAngw::getZeta() const { return zeta; }
inline double SymFncExpAngw::getRs() const { return rs; }

...
public:
     ...
     */
    SymFncAngwExp(ElementMap const& elementMap);
    /** Overload == operator.
     */
...
inline bool SymFncAngwExp::getUseIntegerPow() const { return useIntegerPow; }
inline std::size_t SymFncAngwExp::getE1() const { return e1; }
inline std::size_t SymFncAngwExp::getE2() const { return e2; }
inline int SymFncAngwExp::getZetaInt() const { return zetaInt; }
inline double SymFncAngwExp::getLambda() const { return lambda; }
inline double SymFncAngwExp::getEta() const { return eta; }
inline double SymFncAngwExp::getZeta() const { return zeta; }
inline double SymFncAngwExp::getRs() const { return rs; }

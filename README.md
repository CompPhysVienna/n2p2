...
Most of the links below will not (yet) work from the GitHub project page but
only if you build the offline documentation with `doxygen` (see below).
...
reference](../../src/doc/pair_nnp.html)).
...
- [LAMMPS pair style reference](../../src/doc/pair_nnp.html)

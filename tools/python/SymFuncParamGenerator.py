...
class SymFuncParamGenerator:
    ...
    def generate_radial_params(self, method, mode, r_cutoff, nb_gridpoints, r_lower=None):
        ...
        self.radial_grid_info = {'method': method, 'mode': mode, 'r_cutoff': r_cutoff, 'nb_gridpoints': nb_gridpoints}
